...
"""
This file contains code for running trials of total variation primal dual laplacian learning for binary classification using the two moons dataset.
...
def single_trial(X, labels, label_rate, graph, alpha, lmda, max_iters=10000, tol=1e-8):
    """runs a single trial of training total variation laplacian learning on the two moons dataset for binary classification.
...
if __name__ == '__main__':
    ...
    alpha = 0.1 # learning rate hyperparam
    lmda = 0.1 # regularization hyperparam
    ...
    csv_output_path = f'./results/twomoons_ll_numtrials{num_trials}.csv'
